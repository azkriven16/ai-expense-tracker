...
export const HeroSection = () => {
  return (
    <section className="px-4 md:px-6 relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]"></div>
      <div className="container mx-auto px-4 py-24 md:px-6 lg:py-32 2xl:max-w-[1400px]">
        {/* Announcement Banner */}
        <div className="flex justify-center">
          <a
            className="inline-flex items-center gap-x-2 rounded-full border p-1 ps-3 text-xs md:text-sm transition"
            href="#"
          >
        ...
        <div className="mx-auto mt-5 max-w-2xl text-center">
          <h1 className="scroll-m-10 md:scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
        ...
        {/* Buttons - Enhanced Mobile Responsive */}
        ...
        {/* End Buttons */}
        <div className="mt-5 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-x-3 text-center">
